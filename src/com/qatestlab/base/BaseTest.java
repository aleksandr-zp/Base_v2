...
public class BaseTest {
	...
	public String[][] getTableArray(String xlFilePath, String sheetName, String tableName) throws Exception {
		String[][] tabArray;
        String fileName =  xlFilePath.substring(0, xlFilePath.lastIndexOf("."));
        String fileExtension = xlFilePath.substring(xlFilePath.lastIndexOf("."));
        String domain = Constants.BASE_URL.substring(Constants.BASE_URL.indexOf("://") + "://".length());
        String server = domain.substring(0, domain.indexOf(".")).toUpperCase();
        String computedPath = fileName + "-" + server + fileExtension;

        Workbook workbook = Workbook.getWorkbook(new File(computedPath));
		...
		Sheet sheet = workbook.getSheet(sheetName + "-" + browser);
